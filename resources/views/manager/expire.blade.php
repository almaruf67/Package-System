...
@section('content')
    <section>
        <div class="container">
            <h3 class="text-center">Buy a Package or Renew your package to continue</h3> <br><br>
            <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <form class="card-wrapper" action="{{ route('payment') }}" method="post">
                            ...
                            <div class="text-overlay">
                                <h3>{{ $plan['name'] }}</h3>
                                <input type="number" class="d-none" id="price{{ $loop->iteration }}"
                                    value="{{ $plan['price'] }}">
                            ...
                            <div class="purchase-button-container2">
                                <h5 class="back-h2">
                                    ৳<input type="number" class="col-4" id="u_price{{ $loop->iteration }}" name="u_price"
                                        value="{{ $plan['price'] }}" readonly>
                                    /<input type="number" name="month" class="col-3" id="month{{ $loop->iteration }}"
                                        value="1" min="1" onchange="updateTotal(this,{{ $loop->iteration }})">
                                    Months
                                </h5>
