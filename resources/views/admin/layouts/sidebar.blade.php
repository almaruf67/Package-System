...
<aside class="sidebar-wrapper" data-simplebar="true">
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li>
                    <a href="#"><i class="bi bi-arrow-right-short"></i>Plan Details</a>
                </li>
                <li>
                    <a href="#"><i class="bi bi-arrow-right-short"></i>Add Plan</a>
                </li>
            </ul>
        </li>
        ...
        <li>
            ...
            <ul>
                ...
                <li>
                    <a href="{{ route('Subshow') }}"><i class="bi bi-arrow-right-short"></i>Subscribed User Details</a>
                </li>
            </ul>
        </li>
